...
window.addEventListener('DOMContentLoaded', function() {
  document.getElementById('kill').addEventListener('click', stopApp);
});

// Populate input fields from query params (vanilla JS)
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (params.has('refresh')) {
    document.getElementById('refresh').value = params.get('refresh');
  }
});
